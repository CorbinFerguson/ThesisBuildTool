...
namespace GuiTesting
{
    ...
    public class GUITesting
    {
        ...
        private readonly string TestXMLsPath = Path.GetFullPath(Path.Combine(TestHelper.GetRootFolder(), "L5XFiles", "TestingFiles"));
        ...
        public void ActionSelectLoseControl()
        {
            ...
            foreach (AutomationElement button in mainMenuButtons)
            {
                ...
                TestReport.IsNotNull(popup, "Open popup window for: " + button.Name);
